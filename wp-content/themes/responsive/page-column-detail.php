...
$column_id = get_query_var('column_id');
$args = array(
  'p' => $column_id,
);
...
<h3 class="main-title"><span class="ic-pen">特集・コラム</span></h3>
<div class="box1">

<?php
$posts = get_posts('numberposts=5&exclude='.get_the_ID());
if($posts):
...
?>
    ...
    <div class="link-button"><a href="/column">特集・コラムをもっと見る</a></div>
</div>
